...
CLASSIFIERS = {
    'dummy': DummyClassifier(
        random_state=1607), 'MNB': MultinomialNB(), 'RFC': RandomForestClassifier(
            random_state=1607), 'GBC': GradientBoostingClassifier(
                random_state=1607), 'BGC': BaggingClassifier(
                    random_state=1607), 'LGR': LogisticRegression(
                        random_state=1607), 'SVM': SGDClassifier(
                            random_state=1607), 'XTC': ExtraTreesClassifier(
                                random_state=1607), 'XGB': XGBClassifier(
                                    random_state=1607)}
